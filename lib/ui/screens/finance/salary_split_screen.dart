            ...
            Card(
              child: Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('Распределено: $totalPercent%  (${_fmt(allocated)})'),
                    const SizedBox(height: 8),
                    Text(
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('ЗП: ${formatMoney(salary)}', style: Theme.of(context).textTheme.titleSmall),
            const SizedBox(height: 6),
          ...
          children: [
            Row(
              children: [
                ...
                Text(
                  currentPercent == 0 ? '—' : fmt.format(_amount(salary, currentPercent)),
